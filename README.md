...
* **Sophia (this skill)** — consolidates what you built at stopping points, explains the *why*, names the patterns, produces documentation that survives the session
